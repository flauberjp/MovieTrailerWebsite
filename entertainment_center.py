...
john_wick = media.Movie("John Wick",
                        ...
                        "https://vignette.wikia.nocookie.net/john-wick8561/" +
                        "images/2/29/John_Wick_Poster_003.jpg",
...
avatar = media.Movie("Avatar",
                     ...
                     "https://www.topteny.com/wp-content/uploads/2015/02/" +
                     "poster.jpg",
...
the_godfather = media.Movie(
    ...
    "http://img.goldposter.com/2015/04/" +
    "The-Godfather_poster_goldposter_com_2.jpg",
    "https://www.youtube.com/watch?v=sY1S34973zA")

braveheart = media.Movie(
    "BRAVEHEART",
    174,
    "When his secret bride is executed for assaulting an English soldier " +
    "who tried to rape her, William Wallace begins a revolt against King " +
    "Edward I of England.",
    "http://t0.gstatic.com/images?q=" +
    "tbn:ANd9GcSnnenelmzF4MKdtHBnaQYbDstLRExO1brKmrTBe_Ve40Vwq_lO",
...
the_last_of_mohicans = media.Movie(
    ...
    "Uncas, his father Chingachgook, and his adopted half-white brother " +
    "Hawkeye -- live in peace alongside British colonists. But when the " +
    "daughters of a British colonel are kidnapped by a traitorous scout, " +
    "Hawkeye and Uncas must rescue them in the crossfire of a gruesome " +
    "military conflict of which they wanted no part: the French and " +
    "Indian War.",
...
the_lord_of_the_rings = media.Movie(
    ...
    175,
    "In a small village in the Shire a young Hobbit named Frodo (Elijah " +
    "Wood) has been entrusted with an ancient Ring. Now he must embark on " +
